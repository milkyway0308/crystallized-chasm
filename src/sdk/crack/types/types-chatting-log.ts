...
export class CrackChattingLog {
  ...
  constructor(
    ...
    public recommendList: string[],
    public crackerModel: string,
    public chatModelId: string,
    public isContinuallyGeneratable: boolean,
    public isContinued: boolean,
    public situationImages: string[],
    public parameterSnapshots: string[],
    public isPrologue: boolean,
