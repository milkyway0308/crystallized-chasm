...
> 2\. 명확하게 하거나, 확실하게 하다.<br> > _"Chasm crystallized, illuminating a bright future."_<br> > _(열린 틈은 결정화되어 아름다운 미래를 비추었다.)_
...
## 결정화 캐즘 - 붉은 약 (v1.2.2) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/redpill.user.js) ]<br>
...
## 결정화 캐즘 - 과포화 (v1.0.0) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/tmi.user.js) ]<br>

결정화 캐즘 과포화는 채팅의 소모 개수를 과거의 슈퍼챗 개수 표기로 변환하여 소모량 및 잔여량을 더욱 가시적으로 보여줍니다.<br>

## 결정화 캐즘 - 폴드 (v1.0.7) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/fold.user.js) ]<br>
