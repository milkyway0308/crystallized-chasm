...
## 결정화 캐즘 - 붉은 약 (v1.4.1) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/redpill.user.js) ]<br>
...
## 결정화 캐즘 - 이그나이터 / 점화기 (v1.5.0) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/crack/ignitor-crack.user.js) ]<br>

결정화 캐즘 이그나이터는 재작성된 개선된 버너 모듈입니다.

채팅방의 채팅을 외부 LLM에 의탁하여 요약하며, 프롬프트 공유 및 보관이 가능하도록 개선되었습니다.

## 결정화 캐즘 - 버너+ (v1.7.1-FINALE) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/burner.user.js) ]<br>
...
## 결정화 캐즘 - 과포화 (v1.6.2) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/tmi.user.js) ]<br>
...
## 결정화 캐즘 - 계수기 (v1.2.11) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/counter.user.js) ]<br>

결정화 캐즘 계수기는 채팅 입력 칸 위에 현재 채팅이 진행된 턴 수를 표시해줍니다.<br>

## 결정화 캐즘 - 뮤트 (v1.1.11) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/mute.user.js) ]<br>
...
## 결정화 캐즘 - 절대 영도 (v1.1.11) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/absolutezero.user.js) ]<br>

결정화 캐즘 절대영도는 랭킹 화면에서의 GIF / WEBP 재생을 중지하고, 호버하는 대상에만 적용시킵니다.<br>

## 결정화 캐즘 - 국소지진계 (v1.0.1) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/crack/local-seismometer.user.js) ]<br>

결정화 캐즘 국소지진계는 요약 메모리의 변경을 감지하고 알립니다. <br>

## 결정화 캐즘 - 자명종 (v1.0.0) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/crack/alarm-clock.user.js) ]<br>
더 이상의 출석 이벤트 놓침은 그만, 자명종 모듈과 함께 개근상을 노려보세요. <br>

## 결정화 캐즘 - 꿈일기 (v1.1.2) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/crack/dreamdiary.user.js) ]<br>

결정화 캐즘 꿈일기는 유저노트에 목록을 만들어줍니다. <br>

## 결정화 캐즘 - 네뷸라이저 (v1.3.11) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/nebulizer.user.js) ]<br>
