...
## 결정화 캐즘 - 차원이동 (v1.0.0) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/alternation.user.js) ]<br>
...
> ⚠ 현재 채팅과 헷갈리지 않도록 미리 원본 채팅방의 이름을 바꿔두는 것을 권장힙니다.
