# Chasm Crystallized | Atlas - 결정화 캐즘 | 아틀라스 프로젝트
...
**결정화 캐즘 | 아틀라스** 프로젝트는 크랙을 벗어나 바베 플랫폼으로 확장 지원되는 결정화 캐즘 프로젝트입니다.
...
**Q. 다른 플랫폼으로 진출할 예정입니까?**<br>
결정화 캐즘 프로젝트는 현재 지원 기능들의 안정화가 이루어지는대로 새 플랫폼으로의 진출이 예정되어 있습니다.
...
결정화 캐즘은 수정된 [유의적 버전](https://semver.org/lang/ko/)을 사용하며, 다음과 같은 버전 규칙을 사용합니다 : `PLATFORM-FEATURE-vMAJOR.MINOR.FIX`
...
## 결정화 캐즘 - 이그나이터 (BABE-IGNT-v1.3.0) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/babechat/ignitor-babe.user.js) ]<br>

결정화 캐즘 이그나이터는 재작성된 개선된 버너 모듈입니다.

채팅방의 채팅을 외부 LLM에 의탁하여 요약하며, 프롬프트 공유 및 보관이 가능하도록 개선되었습니다.<br>

## 결정화 캐즘 - 백시현상 (BABE-WHOU-v1.0.3) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/babechat/whiteout.user.js) ]<br>

결정화 캐즘 백시현상은 베이비챗에 화이트 모드를 추가해줍니다.<br>
> ⚠ 백시현상 모듈은 서드 파티 구현 특성상 높은 배터리 사용률과 CPU 사용을 야기할 수 있습니다.<br>

## 결정화 캐즘 - 절대 영도 (BABE-AZRO-v1.0.2-FINALE) [ [설치](https://github.com/milkyway0308/crystallized-chasm/raw/refs/heads/main/babechat/absolutezero.user.js) ]<br>
